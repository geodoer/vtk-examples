//https://kitware.github.io/vtk-examples/site/Cxx/ImageData/ImageIteratorDemo/
...
int main(int, char* [])
{
	...
	int* dims = imageData->GetDimensions(); //获取data
	...
	std::cout << "ContinuousIncrements: " << incX << ", " << incY << ", " << incZ << std::endl;
